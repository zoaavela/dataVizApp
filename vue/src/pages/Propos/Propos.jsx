        ...
        <div className="bi-about-container">
            ...
            <section className="bi-about-section contact-section">
                ...
                <div className="contact-actions">
                    <a href="mailto:contact@domaine.com" className="btn-glass-primary" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.75rem', textDecoration: 'none' }}>
                        <Mail size={18} /> Envoyer un e-mail
                    </a>
                    <a href="#" target="_blank" rel="noreferrer" className="btn-glass-secondary" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.75rem', textDecoration: 'none' }}>
